...
export const homeExampleSeedCategories: HomeExampleCategory[] = [
  createCategory("nano-banana-pro", "Nano Banana Pro", "Special", [], "special"),
  createCategory("design", "Design", "Poster", [
    createExample(
    ...
    createExample(
      ...
      "Necklace Nano Banana Generate product photos against a white background, 1 for earrings, 1 for a ring, belonging to the same set as the necklace. Make sure the design across the set is consistent. Maintain a cohesive visual tone suitable for a luxury brand website homepage - minimal, elegant, and timeless.",
      [
    ...
    createExample(
      ...
      "Cocoa Puffs Nano Banana Change the product packaging to cucumber flavor.",
      [
    ...
    createExample(
      ...
      "Midjourney A velvet, bright orange sculptural tubular chair.",
      [
    ...
    createExample(
      ...
      "Interior Gemini Imagen 4 Generate 5 different interiors - different furniture pieces, colors, space - in the same style and mood.",
      [
  ...
  createCategory("branding", "Branding", "Branding", [
    createExample(
      "Generate logo options.",
      "Gemini Imagen 4 Minimalist vector cartoon logo for a sushi shop. Use simple, bold, rounded lines. Very clean, modern, and well designed.",
      [
    ...
    createExample(
      ...
      "Logo Nano Banana Generate a studio product shot of a light blue cap featuring this logo embroidered on the front. The cap should appear realistic, well-lit, and minimal, placed on a neutral background. The embroidery should be in black thread, flat and subtle.",
      [
    ...
    createExample(
      ...
      "Use Nano Banana to make Board the sidewalk board display Image this exact ice cream image.",
      [
  ...
  createCategory("illustration", "Illustration", "Illustration", [
    createExample(
      "From sketch to endless illustration styles.",
      "Cat Nano Banana Turn this sketch into a 2D illustration, try 5 different styles.",
      [
    ...
    createExample(
      ...
      "Image Nano Banana Turn this photo into a detailed ink drawing with fine lines and blue ink tones, drawn on a light grey dot grid notebook page. Maintain aspect ratio.",
      [
    ...
    createExample(
      "Make surrealist art.",
      "Spoon Umbrella Coca-Cola Egg Cherry Hat Box Stool Bunny Use these objects to generate a surrealist painting; use them however you like and however many times you like.",
      [
    ...
    createExample(
      ...
      "Use Nano Banana to generate a bold, colourful 2D indie illustration of this object Avocado against a playful tablecloth pattern in the same style as Reference this drawing.",
      [
    ...
    createExample(
      ...
      "Nano Banana Expand this illustration Image and make the aspect ratio 16:9.",
      [
  ...
  createCategory("e-commerce", "E-Commerce", "Character", [
    createExample(
      "Show your clothing on a model.",
      "Model Sweater Nano Banana Change her top to this sweater.",
      [
    ...
    createExample(
      ...
      "Front View Nano Banana Show me a back view and a side view of the model, maintain photography style.",
      [
    ...
    createExample(
      ...
      "Necklace Seedream 4 Generate a series of five luxury haute jewelry fashion editorial photographs for a website showcasing this necklace.",
      [
    ...
    createExample(
      ...
      "Ceramic Nano Banana Generate 5 minimal, creative stylised lifestyle images for this ceramic dish, all in 4:5 aspect ratio.",
      [
    ...
    createExample(
      ...
      "Sofa Nano Banana Showcase this sofa in a clean, well decorated, cozy, modern, scandinavian interior with soft daylight and neutral material palette.",
      [
  ...
  createCategory("video", "Video", "Video", [
    createExample(
      "Turn product photos into 360° videos.",
      "Kling 2.5 Turbo Use this Ring as the start and end frame, generate a video of the ring rotating in slow motion.",
      [
        "https://a.lovart.ai/artifacts/agent/jFqgSmuIUbpvqHRv.png?x-oss-process=image/resize,w_200,m_lfit/format,webp",
        "https://a.lovart.ai/artifacts/agent/SWdzcH70E2abBI5Y.png?x-oss-process=image/resize,w_200,m_lfit/format,webp",
        "https://a.lovart.ai/artifacts/agent/VFV1rds5ACSnycVs.png?x-oss-process=image/resize,w_200,m_lfit/format,webp",
    ...
    createExample(
      ...
      "Poster Kling 2.5 Turbo Animate the perfume product while keeping the background completely still.",
      [
        "https://a.lovart.ai/artifacts/agent/WGzLhrXISfmmSkpD.png?x-oss-process=image/resize,w_200,m_lfit/format,webp",
        "https://a.lovart.ai/artifacts/agent/Giq3HbyDtbnRLDcm.png?x-oss-process=image/resize,w_200,m_lfit/format,webp",
        "https://a.lovart.ai/artifacts/agent/kkhjiksTn2scecea.png?x-oss-process=image/resize,w_200,m_lfit/format,webp",
    ...
    createExample(
      ...
      "Model Kling 2.5 Turbo Have the model walk, the camera follows her.",
      [
